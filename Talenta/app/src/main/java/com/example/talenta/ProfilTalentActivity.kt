...
class ProfilTalentActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_profil_talent)
        ...
        if (userId != null) {
            ...
            val call = apiService.getTalent(userId)
                    ...
                    if (response.isSuccessful) {
                        ...
                        if (user != null) {
                            ...
                            btnUpdate.setOnClickListener {
                                ...
                                updateTalent(userId, etNewEmail.text.toString(), etNewPassword.text.toString())
                            }
                        } else {
        ...
        btnRetour.setOnClickListener {
            ...
            val intent = Intent(this@ProfilTalentActivity, MainTalentActivity::class.java)
            startActivity(intent)
            finish() // Facultatif : ferme l'activité actuelle
        }
    }

    private fun updateTalent(userId: String, newEmail: String, newPassword: String) {
        val retrofit = Retrofit.Builder()
            .baseUrl("http://10.0.2.2:5002/")
            .addConverterFactory(GsonConverterFactory.create())
            .build()
        ...
        val updateCall = apiService.updateTalent(userId, updateData)
        ...
        updateCall.enqueue(object : Callback<Void> {
            override fun onResponse(call: Call<Void>, response: Response<Void>) {
                if (response.isSuccessful) {
                    ...
                    Toast.makeText(this@ProfilTalentActivity, "Mise à jour réussie", Toast.LENGTH_SHORT).show()
                } else {
                    Log.d("ProfilUserActivity", "Erreur lors de la mise à jour. Code d'erreur: ${response.code()}")
                    Toast.makeText(this@ProfilTalentActivity, "Erreur lors de la mise à jour. Veuillez réessayer.", Toast.LENGTH_SHORT).show()
            ...
            override fun onFailure(call: Call<Void>, t: Throwable) {
                ...
                Toast.makeText(this@ProfilTalentActivity, "Erreur réseau lors de la mise à jour. Veuillez réessayer.", Toast.LENGTH_SHORT).show()
